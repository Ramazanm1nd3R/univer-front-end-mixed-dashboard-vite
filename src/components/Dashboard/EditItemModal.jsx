...
function EditItemModal({ item, onClose, onUpdate }) {
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    const success = await onUpdate({ ...item, ...formData });
    setIsSubmitting(false);

    if (success) {
      onClose();
    }
  }, [formData, item, onClose, onUpdate, validateAll]);
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content modal-modern" onClick={(e) => e.stopPropagation()}>
          ...
          <form onSubmit={handleSubmit} className="modal-form">
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <select id="edit-category" name="category" value={formData.category} onChange={handleChange} className="form-select">
              ...
              <div className="form-group">
                ...
                <select id="edit-status" name="status" value={formData.status} onChange={handleChange} className="form-select">
        ...
        <div className="modal-footer">
          ...
          <button type="submit" className="btn-primary btn-edit" onClick={handleSubmit} disabled={isSubmitting}>
